...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(user_id, name, category, details, price, image) VALUES(?,?,?,?,?,?)");
      $insert_products->execute([$user_id, $name, $category, $details, $price, $image]);
      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>select category</option>
               ...
               <option value="cereals/ legumes">cereals/ legumes</option>
