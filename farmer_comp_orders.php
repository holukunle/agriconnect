...
<body>
   ...
   <section class="placed-orders">
      ...
      <div class="box-container">
         ...
         $select_orders->execute([$user_id, 'completed']);
               ...
               <div class="box">
                  ...
                  <form action="" method="POST">
                     ...
                     <div class="flex-btn">
                        ...
                        <a href="farmer_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('delete this order?');">delete</a>
                     </div>
                  </form>
               </div>
