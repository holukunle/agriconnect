      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>select category</option>
               <option value="vegitables">fruits/ vegetables</option>
               <option value="fruits">cereals/ legumes</option>
               <option value="meat">tubers</option>
               <option value="fish">livestocks</option>
         </select>
         </div>
         <div class="inputBox">
